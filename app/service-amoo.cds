...
annotate service.salesorder_nps with @Consumption.dbHints: ['USE_HEX_PLAN','HEX_INDEX_JOIN'];
...
annotate service.salesorder_nps with {
    @Common.Text           : SO_LANDX
    @Common.TextArrangement: #TextLast
    SO_LAND1;
    @Common.TextFor
