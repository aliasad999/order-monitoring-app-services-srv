...
annotate service.baseEntity with {
    ...
    SO_ERDAT_ORDER              @sap.filter.restriction:'interval'  @title: '{i18n>SO_ERDAT_ORDER}'              @sap.Label: '{i18n>SO_ERDAT_ORDER}';
    SO_ERDAT_ITEM               @sap.filter.restriction:'interval'  @title: '{i18n>SO_ERDAT_ITEM}'               @sap.Label: '{i18n>SO_ERDAT_ITEM}';
    ...
    SO_PRSDT                    @sap.filter.restriction:'interval'  @title: '{i18n>SO_PRSDT}'                    @sap.Label: '{i18n>SO_PRSDT}';
    ...
    DL_LFDAT                    @sap.filter.restriction:'interval'   @title: '{i18n>DL_LFDAT}'                    @sap.Label: '{i18n>DL_LFDAT}';
    DL_HSDAT                    @sap.filter.restriction:'interval'   @title: '{i18n>DL_HSDAT}'                    @sap.Label: '{i18n>DL_HSDAT}';
    DL_VFDAT                    @sap.filter.restriction:'interval'   @title: '{i18n>DL_VFDAT}'                    @sap.Label: '{i18n>DL_VFDAT}';
    ...
    TM_DPTBG                    @sap.filter.restriction:'interval'  @title: '{i18n>TM_DPTBG}'                    @sap.Label: '{i18n>TM_DPTBG}';
    TM_DATBG                    @sap.filter.restriction:'interval'  @title: '{i18n>TM_DATBG}'                    @sap.Label: '{i18n>TM_DATBG}';
    TM_DPTEN                    @sap.filter.restriction:'interval'  @title: '{i18n>TM_DPTEN}'                    @sap.Label: '{i18n>TM_DPTEN}';
    TM_DATEN                    @sap.filter.restriction:'interval'  @title: '{i18n>TM_DATEN}'                    @sap.Label: '{i18n>TM_DATEN}';
    TM_AR_DATE                  @sap.filter.restriction:'interval'  @title: '{i18n>TM_AR_DATE}'                  @sap.Label: '{i18n>TM_AR_DATE}';
    ...
    DL_WADAT                    @sap.filter.restriction:'interval'  @title: '{i18n>DL_WADAT}'                    @sap.Label: '{i18n>DL_WADAT}';
    DL_WADAT_IST                @sap.filter.restriction:'interval'  @title: '{i18n>DL_WADAT_IST}'                @sap.Label: '{i18n>DL_WADAT_IST}';
    ...
    SO_F_TDDAT                  @sap.filter.restriction:'interval'  @title: '{i18n>SO_F_TDDAT}'                  @sap.Label: '{i18n>SO_F_TDDAT}';
    ...
    SO_F_LDDAT                  @sap.filter.restriction:'interval'  @title: '{i18n>SO_F_LDDAT}'                  @sap.Label: '{i18n>SO_F_LDDAT}';
...
annotate service.baseEntity with {
    ...
    SO_KNREF_HEAD               @title: '{i18n>SO_KNREF_HEAD}'               @sap.Label: '{i18n>SO_KNREF_HEAD}';
    SO_VBUND                    @title: '{i18n>SO_VBUND}'                    @sap.Label: '{i18n>SO_VBUND}';
    SO_EDATU_REQUESTED          @sap.filter.restriction:'interval'  @title: '{i18n>SO_EDATU_REQUESTED}'          @sap.Label: '{i18n>SO_EDATU_REQUESTED}';
    SO_KWMENG                   @title: '{i18n>SO_KWMENG}'                   @sap.Label: '{i18n>SO_KWMENG}';
    SO_VRKME                    @title: '{i18n>SO_VRKME}'                    @sap.Label: '{i18n>SO_VRKME}';
    SO_EDATU_CONFIRMED          @sap.filter.restriction:'interval'  @title: '{i18n>SO_EDATU_CONFIRMED}'          @sap.Label: '{i18n>SO_EDATU_CONFIRMED}';
    SO_KBMENG                   @title: '{i18n>SO_KBMENG}'                   @sap.Label: '{i18n>SO_KBMENG}';
...
// --------------------------------Variants----------------------------------------------------------
annotate service.allIssues with @(UI.PresentationVariant #allIssues : {
    Text : '{i18n>allIssues}',
    Visualizations : [
        '@UI.LineItem'
    ]
});
annotate service.salesorder_nps with @(UI.SelectionVariant #nps_10: {
    Text         : '{i18n>nps_10}',
    SelectOptions: [{
        PropertyName: SO_NPS,
        Ranges      : [{
...
annotate service.salesorder_nps with @(UI.SelectionVariant #nps_20: {
    Text         : '{i18n>nps_20}',
    SelectOptions: [{
        PropertyName: SO_NPS,
        Ranges      : [{
...
annotate service.salesorder_nps with @(UI.SelectionVariant #nps_30: {
    Text         : '{i18n>nps_30}',
    SelectOptions: [{
        PropertyName: SO_NPS,
        Ranges      : [{
...
annotate service.salesorder_nps with @(UI.SelectionVariant #nps_40: {
    Text         : '{i18n>nps_40}',
    SelectOptions: [{
        PropertyName: SO_NPS,
        Ranges      : [{
