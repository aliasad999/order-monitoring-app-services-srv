...
service openOrdersSrv {
    ...
    function isOrderChangeableV2(salesOrder : String(10), salesOrderItem : String(6), salesOrderSystem: String(3)) returns db_app.orderChangeDataV2;
    ...
    entity baseEntitySA               as
        select from db_app.SCHEDULING_AGREEMENTS {
            key null                                        as id                              : UUID,
                MANDT                                       as SO_MANDT,
                FINAL_SO_MANDT                              as SO_FINAL_SO_MANDT,
                FIRST_SO_MANDT                              as SO_FIRST_SO_MANDT,
        ...
        @readonly
        entity schedulingAgreements                as projection on baseEntitySA;
        entity SADetails                           as projection on schedulingAgreements;
        entity SAValueHelps                        as projection on baseEntitySA;
};
