...
service srvOpenOrders {
    ...
    select from db_app.RESULTS
     {
      key null as id : UUID,
          ...
          IFNULL(SO_F_AS_PARTNER_ITM, SO_F_AS_PARTNER_HEAD) AS SO_F_AS_PARTNER : String(8),
          IFNULL(SO_F_AS_PARTNER_NAME_ITM, SO_F_AS_PARTNER_NAME_HEAD) AS SO_F_AS_PARTNER_NAME : String(40),
          DL_VBELN,
          DL_POSNR,
          DL_CHARG,
          DL_LFIMG,
  ...
  entity PartnerSettings as
    ...
    entity ORDERLIST_COUNT as projection on BaseEntityCount {
      *,
      IFNULL(TM_SHIPMENT_CURRENT_STATUS_ELEM, TM_SHIPMENT_CURRENT_STATUS_COMP) as TM_SHIPMENT_CURRENT_STATUS : String(250)
    };
}
